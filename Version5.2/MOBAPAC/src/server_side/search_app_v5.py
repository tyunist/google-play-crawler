        ...
        try:
            ...
            for i in range(len(app_list_by_keyword_each)):  
                ...
                try:
                    ...
                    print "NO category searched for this app"
                    continue
#Following is to filter apps belonging to MEDICAL.
#                 if category_name != "MEDICAL".decode('utf8'):
#                     print "App's category is", category_name
#                     continue
#                 else:
    ...
    write_log(["server_side.search_app::","***********************************END****************************************"]) 
    session.close()
