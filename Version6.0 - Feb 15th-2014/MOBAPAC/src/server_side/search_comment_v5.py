...
def log_in():
    try:
        ...
        print "server_side.search_comment:    Connection error"
...
def search_comment():
    ...
    # print "server_side.search_comment:    Fetching IDs from id table!"
    # write_log(["server_side.search_comment: ",datetime.datetime.utcnow(),'Fetching IDs from id table!'])
    # app_tuple = session.query(Id).all()
    # write_log(["server_side.search_comment: ",datetime.datetime.utcnow(),"Number of apps:", session.query(Id.app_index).count()])
    
    #Search comments for each app_id to get lists of comment_dict and then, pass them to a list
    print "server_side.search_comment:    Searching for new comments!"
...
#             write_log(["server_side.search_comment: ",datetime.datetime.utcnow(),"End of id table!"])
#             break
...
#             continue
            ...
            print "server_side.search_comment:    SSL Error occur!", e
        ...
        #                 write_log(["server_side.search_comment: ",datetime.datetime.utcnow(),"Comment is old. Do nothing"])
                        continue
        ...
        #The remaining cases
                #Just insert all comments
                    ...
                    session.add(comments)
                    session.flush()
        #             write_log(["server_side.search_comment: ",datetime.datetime.utcnow(),"Comment is new, inserted!"])
                session.commit()
                N_comment_inserted_total += N_comment_inserted_each
    ...
    print "server_side.search_comment:    No of searched comments in total:", N_comment_searched_total
    print "server_side.search_comment:    No of N_comment_inserted_total:", N_comment_inserted_total
    print "server_side.search_comment:    No of N_comment_updated_total:", N_comment_updated_total
    print "server_side.search_comment:    No of new comments of new apps", N_comment_inserted_new_app
    print "server_side.search_comment:    No of new comments of old apps",(N_comment_inserted_total- N_comment_inserted_new_app)
    print "server_side.search_comment:    Start process at:", started_at
    print "server_side.search_comment:    End process at:",datetime.datetime.utcnow()
    print "server_side.search_comment:    Total time:",(datetime.datetime.utcnow()-started_at)
    session.close()
