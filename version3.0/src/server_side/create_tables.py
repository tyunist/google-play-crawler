...
#     } 
    ...
    app_one_ratings = Column(Unicode(11), default="".decode('utf8'))
    app_two_ratings = Column(Unicode(11), default="".decode('utf8'))
    app_three_ratings = Column(Unicode(11), default="".decode('utf8'))
    app_four_ratings = Column(Unicode(11), default="".decode('utf8'))
    app_five_ratings = Column(Unicode(11), default="".decode('utf8'))
    app_ratings = Column(INTEGER(UNSIGNED=True), default= 0)
    app_avar_rating = Column(Unicode(6), default="".decode('utf8'))
    app_comments = Column(Unicode(11), default="".decode('utf8'))
    app_description = Column(UnicodeText, default="".decode('utf8'))
    type_index = Column(TINYINT(UNSIGNED=True), nullable=False)
    ...
    restriction_channel_id = Column(Unicode(2), default="".decode('utf8'))
    restriction_device = Column(Unicode(1), default="".decode('utf8'))
    restriction_android_id = Column(Unicode(20), default="".decode('utf8'))
